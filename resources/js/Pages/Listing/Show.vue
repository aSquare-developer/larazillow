<template>
    <div class="flex flex-col-reverse md:grid md:grid-cols-12 gap-4">
        <Box class="col-span-12 md:col-span-7 flex items-center w-full">
            <div class="w-full text-center font-medium text-gray-700">No Images</div>
        </Box>
        <div class="md:col-span-5 flex flex-col gap-4">
            ...
            <Box>
                ...
                <div>
                    <label for="" class="label">Interest rate (2.5%)</label>
                    <input type="range" min="0.1" max="30" step="0.1"
                            class="w-full h-4 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700" />
                    <label for="" class="label">Duration (25 years)</label>
